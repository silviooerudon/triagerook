...
const FAQ: Array<{ q: string; a: string }> = [
  ...
  },
  {
    ...
    a: `GitHub's built-in scanning is free but limited to partner secret patterns. TriageRook adds ${SECRET_PATTERN_FLOOR}+ curated regex patterns, an entropy fallback for custom formats, SAST rules, dependency CVEs across six ecosystems (+ container OS packages via Trivy), IaC checks for Dockerfile, GitHub Actions, Terraform, Kubernetes, CloudFormation and Helm, supply-chain heuristics (typosquatting, install-hook abuse, dependency confusion), a ${HISTORY_COMMIT_COUNT}-commit history replay, a posture grade, and an IAM-risk lens built by a 10-year IAM specialist. One screen, severity-ranked.`,
  },
  {
  ...
  },
  {
    ...
    a: "Yes, fully free. I'm still figuring out what people value enough to pay for — feedback is very welcome.",
  },
  {
